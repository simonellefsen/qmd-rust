...
//!
//! Each command lives in its own file for maintainability. (Context and Cleanup
//! were extracted into their own modules in the review fix round to resolve
//! finding #1 while still delivering the original smallest-viable implementation
//! under the "no new files" rule of the primary task pass.)
